...
const LoggedProducts = () => {
  ...
  return (
    <div className='ProductsSection' style={{backgroundColor:"#8182C5",padding:"50px 0"}}>
      <div>
        <div>
            <h2 className='text-white text-capitalize text-center my-5'>featured products</h2>
        </div>
        <div>
            <Swiper
